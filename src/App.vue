<script>
import { ref } from 'vue'
import {FVirtualList} from './components/combin/index'
...
<template>
  <main>
    ...
    <div class="btn-flex">
      ...
      <button @click="handleScrollToBottom">滚动到底部位置</button>
      <button @click="handleScrollToIndex">滚动到指定索引</button>
      <button @click="handleScrollToOffset">
          滚动到相对指定偏移量
      </button>
    </div>
  </main>
